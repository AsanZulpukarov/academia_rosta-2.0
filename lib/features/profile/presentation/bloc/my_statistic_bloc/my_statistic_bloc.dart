...
class MyStatisticBloc extends Bloc<MyStatisticEvent, MyStatisticState> {
  ...
  GetStudentStatisticUseCase getStudentStatisticUseCase;

  MyStatisticBloc(this.getMyStatisticUseCase, this.getStudentStatisticUseCase)
    ...
    on<StudentGroupStatisticEvent>((event, emit) async {
      emit(MyStatisticLoadingState());
      final errorOrSuccess = await getStudentStatisticUseCase.call(
        GetStudentStatistic(
