...
class GetLastThreeLessonHistoryUseCase extends UseCase<void, Object> {
  final GroupRepository appRepository;

  GetLastThreeLessonHistoryUseCase(this.appRepository);

  @override
  Future<Either<Failure, void>> call(Object params) async {
    return await appRepository.getLastThreeLessonHistory();
  }
}
