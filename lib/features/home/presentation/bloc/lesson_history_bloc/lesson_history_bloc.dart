...
class LessonHistoryBloc
    extends Bloc<LessonHistoryEvent, LessonHistoryState> {
  GetAllLessonHistoryUseCase getAllLessonHistoryUseCase;
  LessonHistoryBloc(this.getAllLessonHistoryUseCase) : super(LessonHistoryInitialState()) {
    on<LessonHistoryEmptyEvent>((event, emit) async {
      ...
      errorOrSuccess.fold((l) => emit(LessonHistoryErrorState(AppUtils.mapFailureToMessage(l))), (r) => emit(LessonHistoryLoadedState(lessons: r)));
    });
  }
}
